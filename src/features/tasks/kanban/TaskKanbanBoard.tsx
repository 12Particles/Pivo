...
import { useTaskExecutionStatus } from "../hooks/useTaskExecutionStatus";
...
export function TaskKanbanBoard({
  ...
  // Get task execution statuses from backend events
  const { isTaskRunning } = useTaskExecutionStatus();
                            ...
                            {(provided, snapshot) => (
                              ...
                              >
                                <div className="relative">
                                  ...
                                  />
                                  {column.status === TaskStatus.Working && isTaskRunning(task.id) && (
